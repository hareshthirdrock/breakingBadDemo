...
DetailsPage.propDecorators = {
    dismissFirstModal: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Input }],
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,D_workspace_Arham_Angular_angular_14_breakingbad_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,D_workspace_Arham_Angular_angular_14_breakingbad_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,D_workspace_Arham_Angular_angular_14_breakingbad_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
const openURL = /*#__PURE__*/function () {
  var _ref = (0,D_workspace_Arham_Angular_angular_14_breakingbad_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (url, ev, direction, animation) {
...
module.exports = "ion-icon {\n  font-size: 22px;\n}\n\n.card_details {\n  margin-top: -10%;\n  margin-left: 0;\n  width: 100%;\n  height: auto;\n  border-radius: 25px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
module.exports = "<ion-header>\n  <ion-toolbar>\n  <!-- <ion-icon name=\"arrow-back-outline\"></ion-icon> -->\n  <ion-buttons slot=\"start\">\n    <ion-back-button defaultHref=\"home\" (click)=\"backTohome()\" ></ion-back-button>\n</ion-buttons>\n\n<ion-title>\n  {{item.name}}</ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n  <div style=\"width: 100%; text-align-last: center;\">\n  <img [src]=\"item.img\">\n</div>\n  <ion-card class=\"card_details\">\n\n\n    <!-- <ion-card-header>\n      <ion-card-title>{{item.name}}</ion-card-title>\n    </ion-card-header> -->\n    <ion-card-content>\n      <ion-label>Nickname</ion-label>\n      <ion-item>{{item.nickname}}</ion-item>\n      <ion-label>Occupation</ion-label>\n      <ion-item *ngFor=\"let occ of item.occupation\">\n        {{occ}}\n      </ion-item>\n      <ion-label>Season appearance</ion-label>\n      <ion-item>\n        <ion-row *ngFor=\"let app of item.appearance\">\n          <ion-col size=\"2\">\n            {{app}}\n          </ion-col>\n        </ion-row>\n      </ion-item>\n      <ion-label>Status</ion-label>\n      <ion-item>{{item.status}}</ion-item>\n    </ion-card-content>\n  </ion-card>\n\n</ion-content>\n";
